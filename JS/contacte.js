...
const translations = {
    ...
    addressDetails: "Center, Gemeni 2nd floor <br> Ștefan cel Mare și Sfânt 136, Chișinău, Moldova",
    scheduleTitle: "Schedule",
    scheduleDetails: "Monday - Saturday: 11:00 AM - 7:00 PM <br> Sunday: Closed",
    ...
    phone: "Телефон",
    addressTitle: "Адрес",
    addressDetails: "Центр, ТЦ Gemeni, 2 этаж <br> Штефан чел Маре ши Сфынт 136, Кишинёв, Молдова",
    scheduleTitle: "График",
    scheduleDetails: "Понедельник - Суббота: 11:00 - 19:00 <br> Воскресенье: Выходной",
