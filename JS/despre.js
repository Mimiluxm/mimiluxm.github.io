...
function toggleReadMore() {
    ...
    hiddenText.style.display = hiddenTextVisible ? 'none' : 'block';

    if (hiddenTextVisible) {
        toggleButton.textContent = translations[currentLanguage]["readMore"];
    } else {
        toggleButton.textContent = translations[currentLanguage]["readLess"];
    }

    hiddenTextVisible = !hiddenTextVisible;
}
